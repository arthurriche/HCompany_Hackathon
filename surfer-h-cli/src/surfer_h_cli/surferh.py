...
def emit_feedback_block(answer: str):
    """Print the final feedback between delimiters so downstream tools can capture only the summary."""
...
def agent_loop(
    ...
    while True:
        ...
        if force_answer:
            ...
            emit_feedback_block(navigation_action["content"])
